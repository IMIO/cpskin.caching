...
class TestCpskinRewriter(unittest.TestCase):
    ...
    def _prepareVHMRequest(self, path, domain='imio.be', root='/plone', prefix='', protocol='http'):
    ...
    def test_purge_paths_no_minisite(self):
        self.assertEqual(self.rewriter('/foo'),
    ...
    def test_purge_paths_with_domains_no_minisite(self):
        ...
        self.assertListEqual(self.rewriter('/foo'), [
    ...
    def test_set_protocol_on_domain(self):
        self.assertEqual(self.rewriter.set_protocol_on_domain('imio.be'), 'http://imio.be:80')
        self.assertEqual(self.rewriter.set_protocol_on_domain('imio.be:443'), 'https://imio.be:443')
        self._prepareVHMRequest('/', protocol='https')
        self.assertEqual(self.rewriter.set_protocol_on_domain('bla.imio.be'), 'https://bla.imio.be:443')
        self._prepareVHMRequest('/', protocol='http')
        self.assertEqual(self.rewriter.set_protocol_on_domain('https://communesplone.be'), 'https://communesplone.be:443')
        self.assertEqual(self.rewriter.set_protocol_on_domain('https://bla.imio.be'), 'https://bla.imio.be:443')
